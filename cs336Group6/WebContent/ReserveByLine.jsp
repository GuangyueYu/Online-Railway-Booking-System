...
<b>List of Reservations By Line</b>
...
<% 	
	...
	rs1 = stmt.executeQuery("select count(*) as total,line_name from ReservationSystem.Have_Reservation group by line_name order by count(*) desc");	
	...
	out.print("</tr>");
		...
		%>	<table border = "3" width="100%">
			...
			while (rs1.next()) { 
				...
				out.print(rs1.getString("line_name"));
				out.print("</td>");
				out.print("<td>");
